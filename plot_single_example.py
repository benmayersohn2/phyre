"""
plot_single_example.py: Time series plot of all phytoplankton from single_example.py
...
plt.savefig('plots/single_example.pdf', bbox_inches='tight', pad_inches=0)
plt.show()
